...
本文件夹（`docs/personal/` 中文版）是**个人生产力完整版**——把 GOAA 当作日常生产力工具使用：**100% 人决断、总成本最低**。按文档完成一个端到端示例，你的体系就能持续产出、记忆跨会话不断档。英文版见 [en/README.md](../en/README.md)。
...
**三步开始**：
1. 📁 下载本文件夹（`docs/personal/` 中文版）到本地
...
> ✅ **锚对了吗？自检**：工作区第一层应该直接看到 `README.md` 和 `constitution/` 等文件夹。如果你看到的是 `goaa-main` 这类外层目录名——锚错层了，请把工作区改成本文件夹（`docs/personal/` 中文版）。
...
- **文件=记忆与规则载体**：AI 无记忆，文件在则体系在（物理记忆论）——你的记忆是你的纯文本文件，来去自由（见 [退出指南](exit-guide.md)）
...
> 详见 [docs/applicability.md](applicability.md)
...
| [docs/concepts/](concepts/) | 核心概念逐篇 |
| [docs/goaa-guide.md](goaa-guide.md) | **GOAA 指南与常见问答**——是什么/区别/记忆/安全·下载后必读 |
| [docs/exit-guide.md](exit-guide.md) | **退出指南**——你的数据在你手里·来去自由 |
| [docs/internals/](internals/) | **核心机制原理**——架构核心/记忆体系/裁决闭环/熵治理/运作图 |
...
| [docs/ownership.md](ownership.md) | **所有权说明**——五条检查逐条解释 + 退出迁移指引 |
| [plugins/memory-vector/](../../../plugins/memory-vector/) | **可选插件**——记忆向量索引（不装不影响核心功能） |
| [docs/FAQ.md](FAQ.md) | **常见问题解答**——30个高频问题，覆盖入门/原理/对比/安全/故障排查 |
| [docs/project-introduction.md](project-introduction.md) | 项目介绍补充（外部评价/首创自审/画像） |
...
**提问前请先阅读**：[FAQ.md](FAQ.md) 覆盖了 30 个最常见问题，可能已经有你的答案。
