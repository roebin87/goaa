...
- **Ruling authority**: human final ruling + double anchor (meta-rule judges the mother set · public knowledge judges direction) — the agent never decides true/fake problems on its own
