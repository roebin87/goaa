...
- [Falsification log](docs/falsification-log.md) + [pre-registered disclosure list](docs/known-limits.md) — social-validation evidence chain
- [Compatibility proof](docs/compatibility.md) — GOAA is a substrate; it does not replace any framework
- [Version policy](docs/version-policy.md) — full open + carefully upholding core principles (effective)
