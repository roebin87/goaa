...
| 06 | [Full Dual-Chain Navigation](06-dual-chain-navigation.md) | File-as-ontology, three-layer navigation model, 6 path types, five navigation routes, dead-link=0 health rules (Core full-open) |
...
- **Navigation researchers** (Core): Focus on 06 for the full file-connection and dual-chain navigation scheme
