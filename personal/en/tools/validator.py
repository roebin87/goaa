...
CORE_FILES = [
    ...
    "mechanisms/reuse.md",
    "mechanisms/dynamic-rates.md",
    "methodologies/methodology-01-true-problem.md",
    "methodologies/methodology-02-ambiguity-resolution.md",
    "methodologies/methodology-03-dynamic-rates.md",
    "DEPLOY.md",
]
...
def check_dead_links(ok: list) -> bool:
    ...
    if not defined:
        ...
        return True
    scan_targets = [
        "rules/validation.md", "rules/classification.md",
        "mechanisms", "constitution/design-principles.md",
    ]
...
def main() -> int:
    ...
    try:
        with open("constitution/basic_law.md", "r", encoding="utf-8") as fh:
            law = fh.read()
