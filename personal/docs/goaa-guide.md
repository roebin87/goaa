...
**Q13：学术论文在哪？**
A：GOAA 总纲论文（Zenodo DOI：`10.5281/zenodo.22165301`·概念系列 `10.5281/zenodo.22025298`）——想了解设计原理深度阅读用论文。
...
- 完整设计原理以**学术论文**形式发布（保持本仓库轻量·文件精简可信）：
  - GOAA 总纲论文（Zenodo 版本 DOI）：`10.5281/zenodo.22165301`
  - 概念系列总编号（DOI）：`10.5281/zenodo.22025298`
